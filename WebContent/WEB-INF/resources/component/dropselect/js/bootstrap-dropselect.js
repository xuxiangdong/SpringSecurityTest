	...
	Dropselect.prototype = {
		...
		load: function(items) {
			...
			if (options.filter.show) {
				var $fitler = $('\<li class="dropselect-filter">\<input type="text" class="form-control dropselect-filter-input" placeholder="' + options.filter.placeholder + '">\</li>'),
			...
			if (options.clear.show) {
				var $clear = $('\<li class="dropselect-clear">\<a href="#"><i class="' + options.icons.clear + ' dropselect-item-icon"></i> ' + options.clear.text + ' </a>\</li>\<li class="divider"></li>');
